  ...
  'relative w-full rounded-lg border px-4 py-3 text-sm grid has-[>svg]:grid-cols-[calc(var(--spacing)*4)_1fr] grid-cols-[0_1fr] has-[>svg]:gap-x-3 gap-y-0.5 items-start [&>svg]:size-4 [&>svg]:translate-y-0.5 [&>svg]:text-current',
  {
    variants: {
      variant: {
        ...
        warning: 'text-amber-800 bg-amber-50 border-amber-200 dark:bg-amber-950/30 dark:text-amber-300 dark:border-amber-900',
        success: 'text-emerald-800 bg-emerald-50 border-emerald-200 dark:bg-emerald-950/30 dark:text-emerald-300',
        info: 'text-blue-800 bg-blue-50 border-blue-200 dark:bg-blue-950/30 dark:text-blue-300',
      },
    },
