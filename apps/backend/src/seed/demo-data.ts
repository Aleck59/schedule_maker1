...
export const CLASSROOMS: ClassroomSeed[] = [
  {
    code: 'А-101',
    name: 'Лекционная аудитория №1',
    building: MAIN,
    floor: 1,
    capacity: 60,
    classroomType: 'LECTURE',
    equipment: { projector: true, microphone: true },
    unavailable: [{ weekday: 6, lessons: [4, 5, 6], reason: 'Общеколледжные мероприятия' }],
  },
  {
    code: 'А-102',
    name: 'Лекционная аудитория №2',
    building: MAIN,
    floor: 1,
    capacity: 40,
    classroomType: 'LECTURE',
  ...
  },
  {
    ...
    equipment: { interactiveBoard: true },
  },
  {
    code: 'А-202',
    name: 'Кабинет иностранного языка №1',
    building: MAIN,
    floor: 2,
    capacity: 16,
    classroomType: 'GENERAL',
    equipment: { audio: true },
  },
  {
    code: 'А-203',
    name: 'Кабинет иностранного языка №2',
    building: MAIN,
    floor: 2,
    capacity: 16,
    classroomType: 'GENERAL',
  ...
  {
    code: 'А-204',
    name: 'Кабинет гуманитарных дисциплин',
    building: MAIN,
    floor: 2,
    capacity: 30,
    classroomType: 'GENERAL',
  ...
  {
    code: 'А-205',
    name: 'Кабинет правовых дисциплин и БЖД',
    building: MAIN,
    floor: 2,
    capacity: 30,
    classroomType: 'GENERAL',
    equipment: { projector: true, simulators: true },
  },
  {
    code: 'А-301',
    ...
    equipment: { computers: 26, projector: true },
  },
  {
    code: 'А-302',
    ...
    capacity: 26,
    classroomType: 'COMPUTER_LAB',
    equipment: { computers: 26 },
  },
  {
    code: 'А-303',
    name: 'Компьютерный класс №3 (для подгрупп)',
    building: MAIN,
    floor: 3,
    capacity: 15,
    classroomType: 'COMPUTER_LAB',
    equipment: { computers: 15 },
  },
  {
    code: 'Б-101',
    name: 'Лаборатория компьютерных сетей',
    building: SECOND,
    floor: 1,
    capacity: 26,
    classroomType: 'LABORATORY',
    equipment: { computers: 26, networkRacks: 4 },
  },
  {
    code: 'Б-102',
    name: 'Мастерская по обслуживанию средств вычислительной техники',
    building: SECOND,
    floor: 1,
    capacity: 15,
    classroomType: 'WORKSHOP',
    equipment: { workbenches: 15 },
  },
  {
    code: 'Б-001',
    name: 'Спортивный зал',
    ...
    floor: 0,
    capacity: 60,
    classroomType: 'SPORTS_HALL',
    equipment: { lockers: true },
    unavailable: [{ weekday: 3, lessons: [5, 6], reason: 'Спортивные секции' }],
  },
  {
    code: 'ЭИОС',
    name: 'Дистанционно (электронная образовательная среда)',
    building: 'Онлайн',
    floor: 0,
    capacity: 500,
    classroomType: 'ONLINE',
    equipment: { platform: 'ЭИОС колледжа' },
  },
];
    ...
    semesters: [
      {
        ...
        selfStudy: 29,
        control: 'EXAM',
        practicalRoomTypes: ['GENERAL', 'LECTURE'],
      },
    ],
    ...
    semesters: [
      {
        ...
        selfStudy: 4,
        control: 'DIFFERENTIATED_CREDIT',
        laboratoryRoomTypes: ['COMPUTER_LAB'],
      },
    ],
    assignments: [
    ...
    semesters: [
      {
        ...
        practiceRoomTypes: ['COMPUTER_LAB'],
      },
    ],
  ...
  return [
    ...
    },
    {
      ...
      periods: [
        { type: 'THEORETICAL_TRAINING', start: '01-12', end: '05-31', title: 'Теоретическое обучение' },
        {
          ...
          title: 'Учебная практика УП.01 (на базе колледжа)',
        },
    ...
    },
    {
      ...
      periods: [
        ...
        {
          type: 'INDUSTRIAL_PRACTICE',
          start: '11-23',
          end: '12-20',
          title: 'Производственная практика ПП.01 (на предприятиях)',
        },
    ...
    },
    {
      ...
      periods: [
        ...
        {
          type: 'DEMO_EXAM_PREPARATION',
          start: '04-24',
          end: '05-01',
          title: 'Подготовка к демонстрационному экзамену',
        },
